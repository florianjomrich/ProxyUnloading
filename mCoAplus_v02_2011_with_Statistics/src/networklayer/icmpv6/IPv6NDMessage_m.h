...
class IPv6NDPrefixInformation : public ::cObject
{
  ...
  public:
    ...
    virtual bool getRouterAddress() const;
    virtual void setRouterAddress(bool routerAddress);
...
class MIPv6NDAdvertisementInterval : public ::cObject
{
  ...
  public:
    ...
    // field getter/setter methods
    virtual unsigned int advertisementInterval() const;
