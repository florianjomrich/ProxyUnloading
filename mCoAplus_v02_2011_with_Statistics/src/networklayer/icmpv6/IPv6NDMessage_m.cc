...
bool IPv6NDPrefixInformation::getRouterAddress() const
{
    return routerAddress_var;
}

void IPv6NDPrefixInformation::setRouterAddress(bool routerAddress)
{
...
int IPv6NDPrefixInformationDescriptor::findField(void *object, const char *fieldName) const
{
    ...
    if (fieldName[0]=='r' && strcmp(fieldName, "routerAddress")==0) return base+3;
...
std::string IPv6NDPrefixInformationDescriptor::getFieldAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 3: return bool2string(pp->getRouterAddress());
...
bool IPv6NDPrefixInformationDescriptor::setFieldAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 3: pp->setRouterAddress(string2bool(value)); return true;
...
unsigned int MIPv6NDAdvertisementInterval::advertisementInterval() const
{
...
std::string MIPv6NDAdvertisementIntervalDescriptor::getFieldAsString(void *object, int field, int i) const
{
    ...
    MIPv6NDAdvertisementInterval *pp = (MIPv6NDAdvertisementInterval *)object; (void)pp;
    switch (field) {
        case 0: return ulong2string(pp->advertisementInterval());
        default: return "";
    }
}
