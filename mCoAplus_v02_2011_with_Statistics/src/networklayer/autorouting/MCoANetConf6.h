...
#ifndef MYNETCONF6_H_
#define MYNETCONF6_H_

#include <omnetpp.h>
#include "INETDefs.h"

/**
 * Configures routing tables for a network by reading XML routing file,
 *
 * For more info please see the NED file.
 */
class INET_API MCoANetConf6 : public cSimpleModule
{
  protected:
