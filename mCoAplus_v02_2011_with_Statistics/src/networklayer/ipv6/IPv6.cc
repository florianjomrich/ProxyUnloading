...
#include "RequestForConnectionToLegacyServer.h"
...
/*IPv6ControlInfo* */void IPv6::calculateFlowSourceAddress(
    ...
    if (protocol == IP_PROT_UDP) {//only UDP-Protocol is checked currently
        ...
        // Differenciation in MN, HA und CN does not happen here but on control app layer.
            ...
            uint32_t flowSourceAddress3 = ((srcAdressPart3 + sport + dport
             ...
             IPv6Address* flowSourceAddress = new IPv6Address(flowSourceAddress0,flowSourceAddress1,flowSourceAddress2,flowSourceAddress3);
          /*   IPvXAddress* ipV6Address2 = new IPvXAddress();
             ...
             //CHECK WETHER THE REQUEST WAS SEND ALREADY AND A FEEDBACK FROM HA OR CN arrived
            ...
            //TODO
             ...
             RequestForConnectionToLegacyServer* legacyRequestMessage = new RequestForConnectionToLegacyServer();
