...
unsigned short IPv6RoutingHeader_Base::getRoutingType() const
{
    return routingType_var;
}

void IPv6RoutingHeader_Base::setRoutingType(unsigned short routingType)
{
    this->routingType_var = routingType;
}

unsigned short IPv6RoutingHeader_Base::getSegmentsLeft() const
{
    return segmentsLeft_var;
}

void IPv6RoutingHeader_Base::setSegmentsLeft(unsigned short segmentsLeft)
{
...
IPv6DestinationOptionsHeader_Base::IPv6DestinationOptionsHeader_Base() : ::IPv6ExtensionHeader()
{
}

IPv6DestinationOptionsHeader_Base::IPv6DestinationOptionsHeader_Base(const IPv6DestinationOptionsHeader_Base& other) : ::IPv6ExtensionHeader(other)
{
    copy(other);
}

IPv6DestinationOptionsHeader_Base::~IPv6DestinationOptionsHeader_Base()
{
}

IPv6DestinationOptionsHeader_Base& IPv6DestinationOptionsHeader_Base::operator=(const IPv6DestinationOptionsHeader_Base& other)
{
    if (this==&other) return *this;
    ::IPv6ExtensionHeader::operator=(other);
    copy(other);
...
void IPv6DestinationOptionsHeader_Base::copy(const IPv6DestinationOptionsHeader_Base& other)
{
}

void IPv6DestinationOptionsHeader_Base::parsimPack(cCommBuffer *b)
{
    doPacking(b,(::IPv6ExtensionHeader&)*this);
}

void IPv6DestinationOptionsHeader_Base::parsimUnpack(cCommBuffer *b)
{
    doUnpacking(b,(::IPv6ExtensionHeader&)*this);
}
...
{
    return dynamic_cast<IPv6DestinationOptionsHeader_Base *>(obj)!=NULL;
}
...
int IPv6DestinationOptionsHeaderDescriptor::getArraySize(void *object, int field) const
{
    ...
    IPv6DestinationOptionsHeader_Base *pp = (IPv6DestinationOptionsHeader_Base *)object; (void)pp;
    switch (field) {
        default: return 0;
    }
}
