...
const char *notificationCategoryName(int category)
{
    ...
    switch (category)
    {
        ...
        case NF_IPv6_TUNNEL_ADDED: return "IPv6-TUNNEL-ADD";
        case NF_IPv6_TUNNEL_DELETED: return "IPv6-TUNNEL-DEL";
        ...
        case NF_MIPv6_MN_RETURNED_HOME: return "MIPv6 MN RETURNED HOME";

        case NF_MCOA_APP_PREFERED_ADDRESS: return "MCOA APP PREFERED ADDRESS";
